                              ...
                              sdf::ElementPtr _sdf)
{
  ...
  RCLCPP_INFO_STREAM(this->ros_node_->get_logger(), "==================================================");
  RCLCPP_INFO_STREAM(this->ros_node_->get_logger(), "============       RAY VERSION       =============");
  RCLCPP_INFO_STREAM(this->ros_node_->get_logger(), "==================================================");
  ...
  else
  {
    ...
    if (this->writeLogFlag)
    {
      ...
      RCLCPP_INFO_STREAM(this->ros_node_->get_logger(), "Beam angles at /tmp/SonarRawData_beam_angles.csv");
      RCLCPP_INFO_STREAM(this->ros_node_->get_logger(), "");
    ...
    unsigned int _depth, const std::string &_format)
{
  ...
  this->ros_node_->count_publishers(sonar_image_raw_topic_name_);
